...
_Currently in beta. APIs may change before 1.0._
...
TUIs are notoriously hard to test. \Rooibos makes them testable.
...
Snapshots record both plain text and ANSI colors. Run <tt>UPDATE_SNAPSHOTS=1
rake test</tt> to regenerate baselines after intentional changes.
